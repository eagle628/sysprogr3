...
class Result(View):
    ...
    def get(self, request, *args):
        ...
        FB1 = colormap.Heatmapimage(os.path.join(path,'CV_Module','Map_Honkan','bf_all.jpg'), quality=10)
        ...
        F1 = colormap.Heatmapimage(os.path.join(path,'CV_Module','Map_Honkan','1f_all.jpg'), quality=10)
        for itr in range(0,len(test_result)) :
        ...
        F2 = colormap.Heatmapimage(os.path.join(path,'CV_Module','Map_Honkan','2f_all.jpg'), quality=10)
        for itr in range(0,len(test_result)) :
        ...
        F3 = colormap.Heatmapimage(os.path.join(path,'CV_Module','Map_Honkan','3f_all.jpg'), quality=10)
        for itr in range(0,len(test_result)) :
